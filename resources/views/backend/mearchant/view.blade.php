...
@section('content')
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="">View Mearchant</a></li>
        </ul>
        
        <div class="page-title">                    
            <h2><span class="fa fa-arrow-circle-o-left"></span> View Mearchant</h2>
        </div>
         ...
         <div class="page-content-wrap">
            <div class="row">
                     ...
                     <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h3 class="panel-title">View Mearchant</h3>
                           </div>
                          ...
                          {{--  <div class="panel-footer">
                             <a class="btn btn-primary pull-right" href="{{ url('admin/mearchant') }}"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;<span class="bold">Back</span></a>
                ...
                <div class="panel panel-default">
                          <div class="panel-heading">
                              <h3 class="panel-title">Mearchant Wallet Details List</h3>
                          </div>
                    ...
                    <div class="panel-body" style="overflow: auto;">
                      <table  class="table table-striped table-bordered table-hover">
                        ...
                        $i = 1;
                        @endphp
                            @forelse($getrecord->get_users_mearchant_wallet_details as $value)
                        <tr>
                          <td>{{ $i }}</td>
                          ...
                          <td>
                            <a onclick="return confirm('Are you sure you want to delete?')" href="{{ url('admin/mearchant/view_delete/'.$value->id) }}" class="btn btn-danger btn-rounded btn-sm"><span class="fa fa-trash-o"></span></a>
                          </td>
                        </tr>
...
@endsection
  ...
  <script type="text/javascript">
     $('.changeStatus').change(function(){
      ...
      $.ajax({
        type:'GET',
        url:"{{ url('admin/mearchant/changeStatus') }}",
