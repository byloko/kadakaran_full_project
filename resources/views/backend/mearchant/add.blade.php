...
@section('content')
  ...
  <ul class="breadcrumb">
            ...
            <li><a href="">Add Mearchant</a></li>
        </ul>
        
        <div class="page-title">                    
            <h2><span class="fa fa-arrow-circle-o-left"></span> Add Mearchant</h2>
        </div>
         ...
         <div class="page-content-wrap">
            <div class="row">
                <div class="col-md-12">
                    {{-- Section Start --}}
                       <form class="form-horizontal" method="post" action="{{ url('admin/mearchant/add') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Add Mearchant</h3>
                                </div>
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <label class="col-md-3 col-xs-12 control-label">Mobile Number<span style="color:red"> *</span></label>
                                      <div class="col-md-7 col-xs-12">
                                          <div class="">
                                              <input name="mobile" value="{{ old('mobile') }}" maxlength="10" minlength="10" required placeholder="Mobile Number" type="text" class="form-control" />
